...
<head>
    ...
    <link rel="shortcut icon" href="{{ URL::to('icon.ico') }}"/>
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <li>
                        <a href="{{ URL::to('/extract_content/1') }}">
                            <i class="menu-icon fa fa-caret-right"></i>
                            Extract content
                        </a>
                        <b class="arrow"></b>
