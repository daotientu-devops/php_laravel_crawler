...
// The default value for a timeout in file_get_contents() is 60 seconds. You can change this value through the default_socket_timeout setting.
//It's also doable in your code:
ini_set('default_socket_timeout', 10); // 10 giây
// helper functions
// -----------------------------------------------------------------------------
