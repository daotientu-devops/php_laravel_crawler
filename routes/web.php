...
Route::post('/crawl_page', 'WebsiteController@getCrawlerURL');
//Route::post('/', function () {
...
Route::get('/website_category', 'WebsiteController@getWebsiteCategory');
Route::post('/website_category', 'WebsiteController@storeWebsiteCategory');
// Store danh sách website hỗ trợ crawler
...
//     */
//});
// Danh sách url all site
Route::get('/url', 'WebsiteController@getListUrlAllSite');
// Danh sách url mỗi site
Route::get('/url/{database}/{collection}/{type}/{domain}/{page}', 'WebsiteController@getListUrl');
// Lọc URL tùy theo shop hay forum
Route::get('/filter_url/{database}/{collection}/{type}/{url}', 'WebsiteController@filterUrl');
Route::get('/filter_url/{number_page}', 'WebsiteController@getFilterUrl');
Route::post('/filter_url', 'WebsiteController@postFilterUrl');
Route::get('/extract_content/{number_page}', 'WebsiteController@getExtractContent');
Route::post('/extract_content', 'WebsiteController@postExtractContent');
Route::get('/extract_content/{number_page}/edit/{id}', 'WebsiteController@editExtractContent');
// Update extract content
Route::post('/extract_content/edit/{id}', 'WebsiteController@updateExtractContent');
/**
 * Route: Product
 */
Route::get('/product_category', 'ProductController@getProductCategory');
Route::post('/product_category', 'ProductController@storeProductCategory');
Route::get('/product_state', function () {
    return view('product/product_state');
});
Route::post('/product_state', 'ProductController@storeProductState');
Route::get('/product', 'ProductController@createProduct');
Route::post('/product', 'ProductController@storeProduct');
// GET tags - keywords list relating product
Route::get('/product_keyword', 'ProductController@getProductKeyword');
Route::post('/product_keyword', 'ProductController@storeProductKeyword');
...
Route::get('/evaluate_data/{database}/{collection}', 'CrawlerController@evaluateData');
/**
 * IRet Crawler Lite
 */
