...
<div style="background-color:#eeefff;height:100%">
	<div style="margin-left:20px"><img src="<?php render_theme_path() ?>/images/report.png" align="absmiddle" width="14"/> <a href="http://localhost/laravel-master/public/" target="_top">Dashboard</a></div>
